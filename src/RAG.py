    ...
    def index(
        ...
        """
            ...
            Parameters:
                ...
                max_chunk_size: int | The maximum size* of text a Chunk refers to

            *If not precise the max chunk size will be set to 2000 char
        """
        indexor: Indexor = Indexor(max_chunk_size)
        ...
        self.__database.store_chunks(chunk_corpus)
